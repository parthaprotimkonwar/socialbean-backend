...
public interface Constants {
    ...
    //logo small
    String BACKEND_ASSETS_LOGO = ApplicationConf.readProperty(BACKEND_APP_PROTOCOL)+ "://" + ApplicationConf.readProperty(BACKEND_APP_HOST) + ":" + ApplicationConf.readProperty(BACKEND_APP_PORT) +"/assets/logo_small.jpg";
